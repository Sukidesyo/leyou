    ...
    public void sendMessage(String phone,String code)
    {
        ...
        if (StringUtils.isNotBlank(lastTime)) {
            ...
            try {
                ...
                Credential cred = new Credential("AKIDA4j7Ui9NzLfiY9OkifPs5AyW8UZO7bnx", "LTJvHNDn9G9m9I9lK5VaOwFIky0hz3tU");
...
//            httpProfile.setProxyPort(port);
                ...
                String appid = "1400382279";
                req.setSmsSdkAppid(appid);

                /* 短信签名内容: 使用 UTF-8 编码，必须填写已审核通过的签名，可登录 [短信控制台] 查看签名信息 */
                String sign = "sukidesyo网";
                req.setSign(sign);

                /* 模板 ID: 必须填写已审核通过的模板 ID，可登录 [短信控制台] 查看模板 ID */
                String templateID = "627348";
